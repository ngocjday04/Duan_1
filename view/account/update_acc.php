                    ...
                    <div class="card-body">
                        <form action="index.php?act=update_acc" method="post">
                            <div class="form-group row mb">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="user_name" value="<?= $_SESSION['user_name']['user_name'] ?>" id="user_name" class="form-control" require>
                                </div>
                            </div>
                            <div class="form-group row mb">
                                <label for="tenloai" class="col-md-2 col-form-label">Email:</label>
                                <div class="col-md-10">
                                    <input type="text" name="email" value="<?= $_SESSION['user_name']['email'] ?>" id="email" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row mb">
                                <label for="tenloai" class="col-md-2 col-form-label">Mật khẩu:</label>
                                <div class="col-md-10">
                                    <input type="password" name="password" value="<?= $_SESSION['user_name']['password'] ?>" id="password" class="form-control" require>
                                </div>
                            </div>
                            <div class="form-group row mb">
                                <label for="tenloai" class="col-md-2 col-form-label">Số điện thoại:</label>
                                <div class="col-md-10">
                                    <input type="text" name="tel" value="<?= $_SESSION['user_name']['tel'] ?>" id="tel" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row mb">
                                <label for="tenloai" class="col-md-2 col-form-label">Địa chỉ:</label>
                                <div class="col-md-10">
                                    <input type="text" name="address" value="<?= $_SESSION['user_name']['address'] ?>" id="address" class="form-control">
                                </div>
                            </div>
